...
BLOG_AUTHOR = "Python XY Ubtuntu team"  # (translatable)
BLOG_TITLE = "Python XY for Ubuntu & derivatives"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
#SITE_URL = "hhttp://pythonxyubuntu.github.io/"
# local testing
SITE_URL = "/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pythonxyubuntu.github.io/"
BLOG_EMAIL = "n.tesla@example.com"
BLOG_DESCRIPTION = "This is a randomly updated site on PyXY for Ubuntu"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/blog/', 'News'),
        ("/tasks/", "Tasks"),
	    ((("https://launchpad.net/~pythonxy/+archive/ubuntu/pythonxy-devel", "Download / PPA / Devel"),
        ("https://launchpad.net/~pythonxy/+archive/ubuntu/pythonxy-stable", "Download / PPA / Stable")), 'Download'),
	    ((("https://launchpad.net/~pythonxy", '"Python XY” team'),
	    ("https://code.launchpad.net/~pythonxy/pythonxy-upstream/", "Launchpad Code: Upstream Imports"),
	    ("https://code.launchpad.net/~pythonxy/pythonxy-upstream-debian/", "Launchpad Code: Debian Dirs / Files"),
        ("https://github.com/pythonxyubuntu", "GitHub Tools")), 'Code & Tools'),
	    ((("/categories/index.html", "Tags"),
	    ("/archive.html", "Archive"),
        ("/rss.xml", "RSS feed")), 'Tags / RSS / Archive'),
	    #("/archive.html", "Archive"),
	    #("/categories/index.html", "Tags"),
	    #("/rss.xml", "RSS feed"),
    ),
